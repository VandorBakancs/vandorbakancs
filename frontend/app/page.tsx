...
// Image importálását kivesszük, ha már nem használjuk
...
export default function HomePage() {
  ...
  // Időzítő a képek automatikus váltásához (5 másodpercenként)
  useEffect(() => {
  ...
  return (
    <main className="w-full space-y-16 pb-16">
        ...
        {topImages.map((image, index) => (
          ...
          >
            ...
            <img
              ...
              // Az object-cover biztosítja, hogy ne torzuljon, 
              // a w-full/h-full pedig kitölti a teret.
            />
          </div>
        ))}

        {/* Kis navigációs pöttyök a kép alján */}
      ...
      {/* 📝 TARTALOM KONTÉNER (Szövegek és Kártyák - vissza a normál szélességre) */}
      <div className="max-w-6xl mx-auto px-10 space-y-16">
        ...
        <section className="text-center space-y-6">
          ...
          <Link href="/turak" className="inline-block bg-green-600 text-white px-10 py-5 rounded-3xl font-black uppercase text-sm  hover:scale-105 transition-all">
            Túrák böngészése
          </Link>
        </section>
