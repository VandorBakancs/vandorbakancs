    ...
    <div className="min-h-screen bg-[#f0fdf4] flex items-center justify-center p-6">
      <div className="bg-white w-full max-w-md p-10 rounded-[3.5rem] shadow-2xl border border-green-50">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-black text-green-900 uppercase italic">Regisztráció</h1>
        </div>
        <form className="space-y-4">
          <div className="relative">
            <User className="absolute left-4 top-4 text-green-600" size={20}/>
            <input type="text" placeholder="Teljes név" className="w-full p-4 pl-12 rounded-2xl bg-green-50 border-none outline-none font-bold placeholder:text-green-800/60" />
          </div>
          <div className="relative">
